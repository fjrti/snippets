/**
* compile: g++ -o runtime_mess runtime_mess.cpp -lpthread
*/

#include <pthread.h>
#include <assert.h>

//#define NO_MESS_ONE_CPU
#define NO_MESS_RUNTIME_BARRIER
