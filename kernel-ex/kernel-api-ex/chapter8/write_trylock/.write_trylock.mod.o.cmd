cmd_/tmp/chapter8/write_trylock/write_trylock.mod.o := gcc -Wp,-MD,/tmp/chapter8/write_trylock/.write_trylock.mod.o.d  -nostdinc -isystem /usr/lib/gcc/i486-linux-gnu/4.3.3/include -Iinclude  -I/usr/src/linux-2.6.30/arch/x86/include -include include/linux/autoconf.h -D__KERNEL__ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Os -m32 -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2 -march=i586 -mtune=generic -Wa,-mtune=generic32 -ffreestanding -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -fno-stack-protector -fno-omit-frame-pointer -fno-optimize-sibling-calls -g -Wdeclaration-after-statement -Wno-pointer-sign -fwrapv  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(write_trylock.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(write_trylock)"  -DMODULE -c -o /tmp/chapter8/write_trylock/write_trylock.mod.o /tmp/chapter8/write_trylock/write_trylock.mod.c

deps_/tmp/chapter8/write_trylock/write_trylock.mod.o := \
  /tmp/chapter8/write_trylock/write_trylock.mod.c \
...
/tmp/chapter8/write_trylock/write_trylock.mod.o: $(deps_/tmp/chapter8/write_trylock/write_trylock.mod.o)
