cmd_/tmp/chapter6/alloc_pages/alloc_pages.mod.o := gcc -Wp,-MD,/tmp/chapter6/alloc_pages/.alloc_pages.mod.o.d  -nostdinc -isystem /usr/lib/gcc/i486-linux-gnu/4.3.3/include -Iinclude  -I/usr/src/linux-2.6.30/arch/x86/include -include include/linux/autoconf.h -D__KERNEL__ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Os -m32 -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2 -march=i586 -mtune=generic -Wa,-mtune=generic32 -ffreestanding -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -fno-stack-protector -fno-omit-frame-pointer -fno-optimize-sibling-calls -g -Wdeclaration-after-statement -Wno-pointer-sign -fwrapv  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(alloc_pages.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(alloc_pages)"  -DMODULE -c -o /tmp/chapter6/alloc_pages/alloc_pages.mod.o /tmp/chapter6/alloc_pages/alloc_pages.mod.c

deps_/tmp/chapter6/alloc_pages/alloc_pages.mod.o := \
  /tmp/chapter6/alloc_pages/alloc_pages.mod.c \
...
/tmp/chapter6/alloc_pages/alloc_pages.mod.o: $(deps_/tmp/chapter6/alloc_pages/alloc_pages.mod.o)
